...
class BuildAmberSystems(BuildSystems):
    ...
    def add_ter_to_pckml_result(self, dirs, pdb_file, base_molecule_name):
        ...
        head_rescode, mainchain_rescode, tail_rescode = dirs.retrieve_polymeric_rescodes(base_molecule_name)
    ...
    def generate_3_3_polymer_array_pckml(self, molecule_name, base_molecule_name):
        """
        ...
        if not os.path.exists(output_dir):
            os.makedirs(output_dir)
        array_pdb_name = molecule_name + file_subtype + ".pdb"
        ...
        self.add_ter_to_pckml_result(dirs, array_pdb, base_molecule_name)
        return(None)
